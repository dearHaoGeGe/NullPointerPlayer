 ...
 */
public class FindListviewType2BaseAdapter extends BaseAdapter {

    private Context context;
    private FindNetBeans bean;
    private int position;

    public FindListviewType2BaseAdapter(Context context, FindNetBeans bean, int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_find_listview_type_2, parent, false);
